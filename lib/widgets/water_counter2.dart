        ...
        children: [
          CircularPercentIndicator(
            ...
            center: Column(
              ...
              children: [
                Text("${(context.watch<BackEnd>().waterGoal - context.watch<BackEnd>().currentWater).floor()}", style: const TextStyle(color: Colors.white, fontSize: 30), textAlign: TextAlign.center,),
